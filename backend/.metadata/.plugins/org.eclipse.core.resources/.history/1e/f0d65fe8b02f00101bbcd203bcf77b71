...
public class UsuarioControlador {
	...
	public ResponseEntity<Response> register(@RequestBody Usuario workerDTO) {
	...
	public ResponseEntity<Response> deleteWorker(@PathVariable String workerId, @AuthenticationPrincipal Usuario currentUser) {
	...
	public ResponseEntity<Response> updateWorker(@PathVariable String workerId, @Valid @RequestBody UsuarioDTO workerDTO) {
		Response response = workerService.updateUsuario(workerId, workerDTO); // Asegúrate de implementar este método en
																				// el servicio
		return ResponseEntity.status(response.getStatusCode()).body(response);
	}
}
