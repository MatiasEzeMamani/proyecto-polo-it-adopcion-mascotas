...
public class MascotaControlador {
	...
	@PostMapping("/agregar")
	public ResponseEntity<Response> createPet(@RequestBody MascotaDTO mascotaDTO,
	...
	public ResponseEntity<Response> deletePet(@PathVariable Long mascotaId, @AuthenticationPrincipal Usuario currentUser) {
