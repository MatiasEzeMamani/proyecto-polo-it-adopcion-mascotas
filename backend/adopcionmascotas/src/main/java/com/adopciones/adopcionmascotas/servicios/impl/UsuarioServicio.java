...
public class UsuarioServicio implements IUsuarioServicio {
	...
	public Response login(IniciarSesion iniciarSesion) {
		...
		try {
			...
			authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(iniciarSesion.getEmail(), iniciarSesion.getContrasena()));
			
			var usuario = usuarioRepositorio.findByEmail(iniciarSesion.getEmail()).orElseThrow(()-> new OurException("Usuario no encontrado"));
